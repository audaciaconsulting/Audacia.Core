...
public static class StringExtensions
{
    ...
    public static string ToSafeFilename(this string input)
    {
        ...
        return string.IsNullOrWhiteSpace(input)
            ? input
            : new string([.. input.Trim().Where(c => !invalidCharacters.Contains(c))]);
    }
    ...
    public static string RemoveNonNumeric(this string source)
    {
        return string.IsNullOrWhiteSpace(source)
            ? string.Empty
            : new string([.. source.ToCharArray().Where(e => char.IsDigit(e) || e == '.' || e == '-')]);
    }
    ...
    public static string RemoveNumeric(this string source)
    {
        return string.IsNullOrWhiteSpace(source)
            ? string.Empty
            : new string([.. source.ToCharArray().Where(e => !char.IsDigit(e))]);
    }
    ...
    public static string TrimStart(this string source, string trimmable)
    {
        ...
        {
            source = source[trimmable.Length..];
        }
    ...
    {
        return string.IsNullOrWhiteSpace(input) ? input : char.ToLowerInvariant(input[0]) + input[1..];
    }
    ...
    {
        return string.IsNullOrWhiteSpace(input) ? input : char.ToUpperInvariant(input[0]) + input[1..];
    }
