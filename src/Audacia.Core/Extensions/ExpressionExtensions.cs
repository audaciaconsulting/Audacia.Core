...
public static class ExpressionExtensions
{
    ...
    public static PropertyInfo? GetPropertyInfo(Expression propertyExpression)
    {
        ...
        return declaringType.GetProperty(memberExpression.Member.Name);
    }
    ...
    [SuppressMessage(
        ...
        Justification = "Existing implementation, can be seperated out but must be treated as a breaking change.")]
    [SuppressMessage(
        "Style",
