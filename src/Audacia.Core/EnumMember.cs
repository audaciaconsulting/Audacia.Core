...
public static class EnumMember
{
    ...
    private static bool MatchesDescription(MemberInfo member, string? value)
    {
        ...
        return attribute != null && string.Equals(attribute.Description, value, StringComparison.OrdinalIgnoreCase);
    }
    ...
    private static bool MatchesEnumMember(MemberInfo member, string? value)
    {
        ...
        return attribute != null && string.Equals(attribute.Value, value, StringComparison.OrdinalIgnoreCase);
    }
    ...
    private static bool MatchesDisplay(MemberInfo member, string? value)
    {
        ...
        return attribute != null && string.Equals(attribute.Name, value, StringComparison.OrdinalIgnoreCase);
    }
